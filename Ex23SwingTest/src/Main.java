...
public class Main {
	...
	public static void main(String[] args) {
		...
		//label.setSize(50, 10); //FlowLayout 안에서는 사이즈 지정 안됨!
		frame.add(label);
		
		//TextField - 사용자로부터 글씨 입력받는 컴포넌트
		...
		//이미지 아이콘객체 생성
		ImageIcon icon=new ImageIcon("images/ms21.png");
		//이미지를 실제로 가지고 있는 Image객체 뽑아오기
		Image im=icon.getImage();
		//뽑아온 이미지 객체의 사이즈를 새롭게 만들기!
