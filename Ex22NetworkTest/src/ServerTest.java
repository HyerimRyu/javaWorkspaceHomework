...
public class ServerTest {
	...
	public static void main(String[] args) {
		...
		//1. IP주소 - 컴퓨터의 고유한 주소(숫자): 42억개
		//2. port번호 - 컴퓨터 안에서의 "프로그램" 분류번호: 6만5천개 0~65535개 가능(2의 16승)
						//0~1024까지는 사용하지마 -->wellKnown포트번호 이미 네이버 같은 애들이 쓰고 있어
		...
		try {
			...
			//데이터를 입력받을 스트림 만들기 : 해임달(Socket)에게 무지개로드(InputStream)을 열어주세요!! 요청
			//연결된 client 소켓과 다리 연결!! 
